$(document).ready(function () {
    ...
    $('.job_prog').click(function () {
        ...
        $('#close_btn').css('background', 'url(image/fechar_roxo.png) no-repeat center');
        var str = $('p', this).text();
    ...
    $('.job_ux').click(function () {
        ...
        $('#close_btn').css('background', 'url(image/fechar_azul.png) no-repeat center');
        var str = $('p', this).text();
        $('h1', '#white_content').text(str);
        document.getElementById('white_content').style.display = 'block';
        document.getElementById('black_overlay').style.display = 'block';
    ...
    $('.job_ilu').click(function () {
        ...
        $('#close_btn').css('background', 'url(image/fechar_amarelo.png) no-repeat center');
        var str = $('p', this).text();
        $('h1', '#white_content').text(str);
        document.getElementById('white_content').style.display = 'block';
        document.getElementById('black_overlay').style.display = 'block';
    ...
    $('#submit').mouseover(function(){
        $(this).css('background', 'url(image/essa_vaga_hover.png) no-repeat center');
    });
    $('#submit').mouseout(function(){
        $(this).css('background', 'url(image/essa_vaga_normal.png) no-repeat center');
    });
});
...
function vagas(name) {
    $('#vaga', '#white_content').text(dictionary[name]);
}

var dictionary = {'jux1': 'Informações mal organizadas te tiram do sério? Então essa vaga pode ser sua. Você precisa saber coordenar projetos, conceituar soluções para problemas de usabilidade, formular e aplicar testes de usabilidade, além de manjar de prototipagem e wireframe. Para juntar-se a nós, é importante ser criativo e ter conhecimento em InDesign, Illustrator e Photoshop. Será um diferencial experiência no mercado de games.',
                    ...
                    'jpro2':'Você é da turma dos Jedi ou dos Sith? Na verdade não importa de que lado da Força você está, mas se possui habilidade com Unity 3D, C#, noções de arquitetura cliente/servidor, NGUI e 2dToolkit. Inglês avançado é um diferencial.',
